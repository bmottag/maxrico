...
define('SW_PROJECT_TITLE', 'Reportes MAXRICO');
...
define('SW_DB_USER', 'maxrico');
define('SW_DB_PASSWORD', 'ROv6nhAAlvAe');
define('SW_DB_HOST', '127.0.0.1');
define('SW_DB_DATABASE', 'maxrico');
}
